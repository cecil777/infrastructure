...
func (m *MockIPath) Join(paths ...string) string {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range paths {
...
func (mr *MockIPathMockRecorder) Join(paths ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Join", reflect.TypeOf((*MockIPath)(nil).Join), paths...)
}
