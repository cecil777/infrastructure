...
func (m *MockIRepository) Add(entry IIdentity) error {
	m.ctrl.T.Helper()
...
func (m *MockIRepository) Remove(entry IIdentity) error {
	m.ctrl.T.Helper()
...
func (m *MockIRepository) Save(entry IIdentity) error {
	m.ctrl.T.Helper()
